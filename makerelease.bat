...
@%JAVA% -jar %COMPILE% --compilation_level SIMPLE_OPTIMIZATIONS --js %SRCBROWSERPATH%\Ctrl8.js --js_output_file %DSTBROWSERPATH%\Ctrl8.min.js
@xcopy %SRCBROWSERPATH%\Ctrl8.js %DSTBROWSERPATH% /y
