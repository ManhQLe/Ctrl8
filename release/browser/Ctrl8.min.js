...
Ctrl8.prototype.CpxProp=function(a,c,b){Ctrl8.CalcProp(this,this.___Props,a,function(a,b){return new c(b[a]||(b[a]={}))},b?null:function(a,b,c){c[b]=a})};Ctrl8.prototype.CalcProp=function(a,c,b,d){Ctrl8.CalcProp(this,this.__Props,a,c,b,d)};Ctrl8.DefCompareFx=function(a,c){return a===c};Ctrl8.DefChangeFx=function(a){};
Ctrl8.CreateProp=function(a,c,b,d,e,f,g,h){f?1:f=Ctrl8.DefCompareFx;g?1:g=Ctrl8.DefChangeFx;h={get:function(){return c[b]},configurable:h?!0:!1};e?1:h.set=function(a){f(c[b],a)?0:(c[b]=a,g(a))};Object.defineProperty(a,b,h);c.hasOwnProperty(b)||void 0===d?1:c[b]=d};Ctrl8.CalcProp=function(a,c,b,d,e,f){f={get:function(){return d.call(a,b,c)},configurable:f?!0:!1};e?f.set=function(d){e.call(a,d,b,c)}:1;Object.defineProperty(a,b,f)};
function DrillCtrl(a){DrillCtrl.baseConstructor.call(this,a);for(var c in this.__Props)a=this.__Props[c],"object"==typeof a?this.DrillProp(c,DrillCtrl,a):this.Prop(c)}Ctrl8.ExtendsTo(DrillCtrl);function EventCtrl(a){EventCtrl.baseConstructor.call(this,a);this.__Events=[]}Ctrl8.ExtendsTo(EventCtrl);EventCtrl.prototype.Emit=function(){var a=[].concat.call(arguments),c=a[0];a.splice(0,1);(c=this.__Events[c])?c.forEach(function(b){b.apply(this,a)},this):1};
EventCtrl.prototype.On=function(a,c){var b=this.__Events[a]||(this.__Events[a]=[]);0>b.indexOf(c)?b.push(c):1};EventCtrl.prototype.Off=function(a,c){var b=this.__Events[a]||(this.__Events[a]=[]),d=b.indexOf(c);0<=d?b.splice(d,1):1};function WebCtrl(a,c){WebCtrl.baseConstructor.call(this,c);this.DOM="string"==typeof a?document.querySelector(a):a;var b=WebCtrl.GetInit(this.DOM),d=this.__Props,e;for(e in b)d.hasOwnProperty(e)?1:d[e]=b[e]}EventCtrl.ExtendsTo(WebCtrl);
